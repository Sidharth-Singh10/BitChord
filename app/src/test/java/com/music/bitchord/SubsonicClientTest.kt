...
import com.music.bitchord.data.sources.SubsonicAuthMode
import com.music.bitchord.data.subsonic.SubsonicAuth
...
import com.music.bitchord.data.subsonic.SubsonicUnavailable
...
/**
 * The Subsonic protocol at the seam: what BitChord puts on the wire, and what
...
class SubsonicClientTest {
    ...
    fun `every call carries the token parameters and this app's identity`() = runBlocking {
        ...
        assertEquals("BitChord", query(request, "c"))
